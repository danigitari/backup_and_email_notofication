...
class Mydrive():
    ...
    def upload_files(self, filename, path):
        ...
        folder_id = "1VRd0-XknlDhC4sW1frUtjW6Ik171i7gZ"
        ...
        receiver_email = "support@uzapoint.com"
        password = os.getenv('PASSWORD')
        # message = """
        # Subject: Hi there
        #
        #  The backup job for $CLIENT_NAME database has been successful and uploaded into Google Drive."""
        # error_message = """\
        # Subject: Hi there
        #
        #  error backing-up database."""
        subject = "Backup for " + os.getenv('CLIENT_NAME') + " success "
